...
export default async function CourseDetailPage({ params }: { params: Promise<{ courseId: string }> }) {
  ...
  const course = await prisma.course.findUnique({ where: { id: courseId }, include: { semester: true, enrollments: true, resources: { include: { asset: true, _count: { select: { submissions: true, pageUnderstandingStates: true, pageUnderstandingEvents: true, pageVisits: true } } }, orderBy: [{ sortOrder: "asc" }, { createdAt: "asc" }] } } });
  if (!course) notFound();
