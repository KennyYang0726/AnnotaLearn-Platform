              ...
              <tbody>
                {courses.map((course) => (
                  <tr key={course.id}>
                    ...
                    <td>{formatAppDateTimeDisplay(course.startAt, { dateStyle: "short", timeStyle: "short" })}<br/><span className="subtle">至 {formatAppDateTimeDisplay(course.endAt, { dateStyle: "short", timeStyle: "short" })}</span></td>
