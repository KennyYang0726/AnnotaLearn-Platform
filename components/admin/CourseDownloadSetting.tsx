...
export default function CourseDownloadSetting({ courseId, initialEnabled, endpoint }: { courseId: string; initialEnabled: boolean; endpoint?: string }) {
  ...
  async function toggle() {
    ...
    try {
      const response = await fetch(endpoint || `/api/admin/courses/${courseId}`, {
        method: "PATCH",
