...
export default function CourseResourceOrderControls({ courseId, resourceId, canMoveUp, canMoveDown, endpoint = "/api/admin/course-resources" }: { courseId: string; resourceId: string; canMoveUp: boolean; canMoveDown: boolean; endpoint?: string }) {
